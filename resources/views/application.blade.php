...
<html lang="en">
  <head>
    ...
    <title>Mr Cling Laundry App</title>
    <!-- Styles -->
  ...
  <body>
    <noscript>
      <strong>We're sorry but Mr Cling Laundry App doesn't work properly without JavaScript enabled. Please enable it to continue.</strong>
    </noscript>
    <div id="app">
    </div>
